...
WEBSITE_BUCKET_NAME= 'patrick-2019-web'
...
def version_bucket_files(): #allows your to keep multiple versionsof an object in the same bucket & deleted file are still stored behind curtains
